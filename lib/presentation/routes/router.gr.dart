...
class AppRouter extends _i3.RootStackRouter {
  ...
  final Map<String, _i3.PageFactory> pagesMap = {
    ...
    SummeryDisplay.name: (routeData) {
      return _i3.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i2.SummeryDisplay());
    }
  };
...
/// generated route for
/// [_i2.SummeryDisplay]
class SummeryDisplay extends _i3.PageRouteInfo<void> {
  const SummeryDisplay() : super(SummeryDisplay.name, path: '/summery-display');
